...
export default function ProfileModule() {
  ...
  const { level, progress, nextLevelCredits, currentLevelCredits } = getLevelInfo(totalCreditsEarned);
          ...
          <div className="rounded-3xl bg-white/70 dark:bg-gray-900/60 backdrop-blur-xl border border-white/60 dark:border-gray-800 shadow-xl p-5">
            ...
            <div className="mt-2">
              <div className="flex justify-between text-[11px] text-gray-400 dark:text-gray-500 mb-1">
                <span>{currentLevelCredits} ✦</span>
                <span>{nextLevelCredits} ✦</span>
              </div>
              ...
              <p className="text-center text-[11px] text-gray-400 dark:text-gray-500 mt-1.5">
                Do dalšího levelu {Math.max(0, nextLevelCredits - totalCreditsEarned)} ✦
              </p>
            </div>
          </div>
        </div>
